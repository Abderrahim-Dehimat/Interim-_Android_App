...
public class AdapterCandidatureSansReponse extends RecyclerView.Adapter<AdapterCandidatureSansReponse.ViewHolder> {

    private Context context;
    private List<JobOffer> applications;

    public AdapterCandidatureSansReponse(Context context, List<JobOffer> offers) {
